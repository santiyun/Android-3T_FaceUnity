...
public class MainApplication extends Application {
     ...
     * 回调类引用，用于接收SDK各种回调信令。
     */
    private MyTTTRtcEngineEventHandler mMyTTTRtcEngineEventHandler;

    public MyTTTRtcEngineEventHandler getMyTTTRtcEngineEventHandler() {
        return mMyTTTRtcEngineEventHandler;
    }
    ...
    public void onCreate() {
        ...
        TTTRtcEngine mTTTEngine = TTTRtcEngine.create(getApplicationContext(), <三体appid，官网申请>, mMyTTTRtcEngineEventHandler);
        if (mTTTEngine == null) {
            System.exit(0);
            return;
        }
        ...
        // 初始化相芯美颜
        FaceUnityManager.initFaceUnity(this);
    }
}
