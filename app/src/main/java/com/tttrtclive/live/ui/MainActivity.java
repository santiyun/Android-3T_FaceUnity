...
import com.tttrtclive.live.FaceUnityManager;
...
import com.tttrtclive.live.callback.OnLocalVideoDataCallBack;
...
public class MainActivity extends BaseActivity implements View.OnClickListener, OnLocalVideoDataCallBack {
    ...
    private FaceUnityManager mFaceUnityManager = new FaceUnityManager();
    ...
    protected void onDestroy() {
        mFaceUnityManager.destoryFaceUnity();
        mFaceUnityManager = null;
    ...
    private void initData() {
        ...
        mFaceUnityManager.setupFaceUnity(this);
        // 注册电话来电监听
        ...
        // 注册广播，接收从 MyTTTRtcEngineEventHandler 传递来的信令消息。
    ...
    public void onLocalVideoFrameCaptured(TTTVideoFrame frame) {
        FaceUnityManager faceUnityManager = mFaceUnityManager;
        if (faceUnityManager != null) {
            faceUnityManager.onDrawFrame(frame);
        }
    }
