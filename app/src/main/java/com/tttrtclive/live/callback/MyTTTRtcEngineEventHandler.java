...
public class MyTTTRtcEngineEventHandler extends TTTRtcEngineEventHandler {
    ...
    private OnLocalVideoDataCallBack mOnLocalVideoDataCallBack;

    public MyTTTRtcEngineEventHandler(Context mContext) {
        this.mContext = mContext;
    }

    public void setOnLocalVideoDataCallBack(OnLocalVideoDataCallBack mOnLocalVideoDataCallBack) {
        this.mOnLocalVideoDataCallBack = mOnLocalVideoDataCallBack;
    }
    ...
    public void onLocalVideoFrameCaptured(TTTVideoFrame frame) {
        if (mOnLocalVideoDataCallBack != null) {
            mOnLocalVideoDataCallBack.onLocalVideoFrameCaptured(frame);
        }
    }
